...
const ModalComponent: React.FC<ModalComponentProps> = ({
  ...
  const monthlyService = selectedServices.find(
    (service) => service.name === "Maandtermijn"
  );
  const maandBedrag = monthlyService ? monthlyService.price : 0;
  const totaalInclBTW = maandBedrag;
  const totaalMetKorting = maandBedrag - 25;
              ...
              <div className="text-start p-10 pt-20 pb-20">
                <div className="flex justify-between">
                  <h2 className="md:text-3xl font-bold text-gray-900 mb-5">
                    <span>Bedankt voor uw vertrouwen! </span>
                  </h2>
                  <button
                    onClick={() => setIsOpen(false)}
                  ...
                  <div>
                    <div className="">
                      <h2 className="text-3xl tracking-wide font-semibold text-gray-900 mb-6">
                        <span>
                          Aanvraag formulier <br className="block md:hidden" />{" "}
                          voor een{" "}
                        </span>
                    ...
                    <div className="w-full">
                      ...
                      <div className="mt-3">
                        <input
                          ...
                          className="w-full pt-2.5 pb-2.5 pl-3 placeholder:font-extralight  dark:text-black dark:bg-gray-100 dark:outline-gray-300 placeholder:text-black outline outline-1 outline-gray-300 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                        />
                      </div>
                      <div className="mt-3">
                        <input
                      ...
                      <div className="mt-3">
                        <input
                          ...
                          className="w-full pt-2.5 pb-2.5 pl-3 placeholder:font-extralight  dark:text-black dark:bg-gray-100 dark:outline-gray-300 outline-gray-300 placeholder:text-black outline outline-1  border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                        />
                      </div>
                      {/* <div className="pt-6 pb-2.5">
                        <label className="text-base font-semibold text-gray-700">
                      ...
                      {/* <div className="mt-3">
                        <input
                          ...
                          className="w-full pt-2.5 pb-2.5 pl-3 pr-3 placeholder:font-extralight placeholder:text-black outline outline-1 outline-gray-300 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                        />
                      </div> */}
                      <div className="pt-6 pb-2.5">
                        <label className="text-base font-semibold text-gray-700">
                      ...
                      <div className="mt-3">
                        <textarea
                          ...
                          className="w-full pt-2.5 pb-2.5 pl-3 pr-3 placeholder:font-extralight  dark:text-black dark:bg-gray-100 dark:outline-gray-300 placeholder:text-black outline outline-1 outline-gray-300 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                        />
                      </div>
                    ...
                    <div className="rounded-2xl h-fit mt-10 md:mt-0 bg-neutral-100/50 w-full p-5">
                      ...
                      <dl className="mt-4 space-y-4 w-full">
                        ...
                        <div className="flex justify-between border-t border-gray-200 pt-4">
                          <dt className="text-black font-normal mt-20">
                            {/* Totaal incl. BTW */}
                            Leasebedrag
                          </dt>
                          <dd className="text-black font-normal pt-20">
                            €{totaalInclBTW}
                          </dd>
                        </div>
                        <div className="flex justify-between">
