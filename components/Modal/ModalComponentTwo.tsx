...
interface ModalComponentTwoProps {
  isOpen: boolean;
...
const ModalComponentTwo: React.FC<ModalComponentTwoProps> = ({
  isOpen,
  setIsOpen,
  selectedCard,
  selectedServices,
                  ...
                  <div>
                    <div className="">
                      <h2 className="text-3xl tracking-wide font-semibold text-gray-900 mb-6">
                        <span>
                          Offerte aanvraag <br className="block md:hidden" />{" "}
                          voor{" "}
                        </span>
...
export default ModalComponentTwo;
