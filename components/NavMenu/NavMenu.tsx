        ...
        <NavigationMenuList className="space-x-2 flex items-center">
          {menuItems.map((item) => (
            <NavigationMenuItem key={item.label}>
              {item.dropdown ? (
                <>
                  <NavigationMenuTrigger className="px-3 xl-nav-link py-2 text-[11px] font-normal uppercase tracking-wide hover:tracking-wider hover:font-semibold transition-all duration-300 ease-in-out">
                    {item.label}
                  </NavigationMenuTrigger>
