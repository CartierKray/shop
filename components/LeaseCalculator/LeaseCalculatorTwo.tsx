...
const LeaseCalculatorTwo: React.FC = () => {
  ...
  return (
    <div className="relative w-full pt-20 pb-20 h-full lg:h-[900px] flex items-center">
        ...
        <div className="relative lg:pb-24 pt-20 p-4 flex justify-center items-center">
          <div className="bg-white/5 lg:py-14 outline outline-white/20 backdrop-blur-2xl max-w-[600px] xl:max-w-[650px] 2xl:max-w-[700px] rounded-xl shadow-lg p-8 w-full">
            ...
            <Link href="/contact#contactgegevens">
              <button className="mt-10 w-full whitespace-nowrap px-6 hover:tracking-wider hover:font-medium transition-all duration-300 ease-in-out mb-2 hover:shadow-green-500 hover:bg-green-600  py-2.5 bg-[#c2b293] shadow-inner shadow-[#e3d1ac] rounded-3xl text-white text-sm backdrop-blur-sm">
          ...
          <div className=" mx-auto py-10 bg-white/5 lg:py-14 outline outline-white/20 backdrop-blur-2xl max-w-[600px] xl:max-w-[650px] 2xl:max-w-[700px] rounded-xl shadow-lg p-8 w-full">
            ...
            <ul className="space-y-4 text-white">
              {[
                ...
                <li
                  key={index}
                  className="flex items-start gap-3 font-light md:hover:tracking-wider md:hover:font-semibold transition-all duration-500 ease-in-out"
                >
...
export default LeaseCalculatorTwo;
