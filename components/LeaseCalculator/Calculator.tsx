...
const Calculator: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full flex items-center">
      ...
      <div className="w-full lg:flex mx-auto justify-center items-center">
        {/* Formulier Container */}
        <div className="relative p-4 flex justify-center w-full items-center">
          <div className="bg-white/5 lg:py-14 w-full outline outline-white/20 backdrop-blur-2xl rounded-xl shadow-lg p-6">
            <Image
