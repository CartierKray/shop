...
const HeaderLeaseTwo: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-transparent/85 via-transparent/50 to-stone-800">
        <NavbarNewTwo />
      </div>
      ...
      <div className="-mt-10 lg:-mt-20 absolute top-0 w-full left-0 right-0 bottom-0 flex flex-col justify-center md:items-start md:text-start items-center text-center p-8 md:p-10">
        <div className="w-full flex flex-col items-center md:px-6 py-10 z-10">
          <h1 className="text-[48px] leading-[3.0rem] md:leading-none md:text-5xl tracking-wide lg:text-7xl xl:text-[77px] font-bold text-center text-white">
            Vind Jouw
            <br className="flex md:hidden" />
            <span className="text-amber-500"> Perfecte Auto!</span>
          </h1>
          {/* <p className="text-white tracking-wide font-normal mt-4 text-center">
          ...
          {/* Filter Section */}
          <div className="mt-4 lg:bg-black/25 shadow-2xl lg:backdrop-blur-md lg:p-3 lg:pl-3 lg:pr-3 lg:rounded-full w-full max-w-3xl lg:max-w-5xl flex flex-col lg:flex-row gap-4 z-30 relative">
            <input
              type="text"
              placeholder="Zoek op trefwoorden..."
              className="flex-1 px-4 py-3 border backdrop-blur-sm bg-white/25 placeholder:text-white/80 custom-shadow-small text-white border-white/5 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-500"
            />
            <select className="flex-1 px-4 py-3 border backdrop-blur-sm  bg-white/25 text-white custom-shadow-small trakcing-wide border-white/5 placeholder:text-white/50 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-500">
            ...
            <Link className="" href={"/aanbod"}>
              <button className="hidden lg:block mt-[1.5px] custom-shadow-small tracking-wide px-[13.5px] lg:px-[0.5px]  hover:tracking-widest hover:font-medium transition-all duration-300 ease-in-out bg-amber-500 hover:bg-green-700 hover:shadow-green-600 shadow-inner shadow-amber-400 text-white rounded-full">
                <Search className="scale-90 m-3" />
              </button>
            </Link>
          </div>
          <Link className="w-full" href={"/aanbod"}>
            <div className="lg:hidden text-center mt-1 mx-auto custom-shadow-small max-w-3xl tracking-wide w-full py-2.5 hover:tracking-widest hover:font-medium transition-all duration-300 ease-in-out bg-amber-500 shadow-inner shadow-amber-400 text-white rounded-full">
              Bekijk ons aanbod →
            </div>
          </Link>
