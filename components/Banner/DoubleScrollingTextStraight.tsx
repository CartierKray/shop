...
const DoubleScrollingTextStraight = () => {
  ...
  return (
    <div
      className="w-screen relative rotate-0 overflow-hidden mt-20 lg:mt-36 mb-20"
      style={{ height: "100px" }}
    >
      <motion.div
        animate={controls}
        initial={{ x: 0 }}
        className="whitespace-nowrap flex -ml-20"
        style={{
      ...
      <motion.div
        ...
        initial={{ x: 0 }}
        className="whitespace-nowrap flex -ml-60"
        style={{
          minWidth: "2500vw", // Vergroot de minimale breedte
          position: "absolute",
          top: "60%",
...
export default DoubleScrollingTextStraight;
