...
export default function DarkModeSplit() {
  ...
  return (
    <div className="bg-[#1111]">
      <div className=" p-2">
        <div className="bg-[#0b0f19] rounded-3xl outline outline-[#7e7e7e] text-white px-3 py-[9.25px]">
          {/* Header */}
          <div className="flex items-start gap-4 pt-8 mb-10 z-10 relative">
            <div className="pt-1">
              <svg
          ...
          <div className="max-w-5xl mx-auto rounded-[2rem] border p-2  border-white/10  relative overflow-hidden bg-dot-pattern">
            {/* Comparison container */}
            <div
              ref={containerRef}
              className="relative mx-auto w-full max-w-[375px] aspect-[375/448] rounded-[2rem] overflow-hidden border border-white/10 bg-gray-900"
            >
