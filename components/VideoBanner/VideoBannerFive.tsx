...
const VideoBannerFive: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-transparent/50 via-transparent/50 to-stone-800">
        <NavbarNewTwo />
      </div>
...
export default VideoBannerFive;
