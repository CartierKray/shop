...
import { AnimatedPin } from "../AnimatedPin/AnimatedPin";
            ...
            <div className="order-2 lg:order-1 w-full lg:w-1/2">
              <div className="flex justify-center lg:mt-20 p-5">
                <div className="">
                  ...
                  <p className="text-6xl text-white lg:text-7xl pt-4 tracking-wider uppercase font-semibold relative">
                    Méér <br />
                    dan een <br /> agency
                  </p>
                  <p className="max-w-2xl text-xl pt-5 relative text-white">
                  ...
                  <div className="hidden md:flex gap-x-5 pt-8 relative">
                    <button className="bg-amber-500 hover:bg-[#F3BD3E] pr-8 pl-8 pt-3 pb-3 font-medium">
                      Offerte aanvragen
                    </button>
                    <button className="bg-amber-500 hover:bg-[#F3BD3E] pr-8 pl-8 pt-3 pb-3 font-medium">
                      Neem contact op
