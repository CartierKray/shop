    ...
    <>
      <div className="outline outline-1 scale-90 outline-zinc-400/5 rounded-lg overflow-hidden shadow-lg bg-white z-10">
        ...
        <Image
          width={1000}
          height={10000}
          className="mx-auto w-auto object-cover mt-8 md:mt-16 mb-4 md:mb-8 h-40"
          src={imageSrc}
          alt="Type"
        />
        {/* Titel en lijst met diensten */}
        <div className="px-3 w-full">
          <div className="font-bold text-center text-2xl tracking-normal mb-2 bg-clip-text text-transparent bg-black">
            {title}
          </div>
