...
import { AccordionHomePageTwo } from "../Accordion/AccordionHomePageTwo";

function ImageTextNine() {
  return (
    <div className="md:flex h-fit md:h-[600px] order">
      <div className="w-full md:w-1/2 lg:order-2 flex flex-col justify-center items-center text-center bg-[#171719]">
        <AccordionHomePageTwo />
      </div>
