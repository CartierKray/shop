...
import PrivacyButton from "../CookieModal/PrivacyButton";

const navigation = {
  diensten: [
    { name: "SEO & SEA", href: "/bestelformulier" },
    { name: "Webdesign", href: "/diensten#pakketten" },
    { name: "Marketing", href: "/diensten#pakketten" },
    { name: "Advertenties", href: "/diensten#pakketten" },
  ],

  contact: [
    { name: "+31 (0)6 101 029 52", href: "tel:+31 (0)6 101 029 5" },
    { name: "info@capitalcodex.nl", href: "capitalcodex@hotmail.com" },
    { name: "Maandag t/m vrijdag", href: "#" },
    { name: "09:00 t/m 18:00", href: "#" },
  ],
  ...
  bedrijf: [
    { name: "Capital Code X", href: "#" },
    { name: "Nijenburg 98", href: "" },
    { name: "1081GG Amsterdam", href: "#" },
    { name: "KVK: 93095171", href: "" },
  ],
...
export default function FooterBlackBlack() {
  return (
    <>
      <footer
        className="relative bg-gradient-to-b from-black to-emerald-600 text-white pt-20"
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              ...
              <Image
                ...
                width={1000}
                height={1000}
                className="w-20 -mt-[80px] md:-mt-[30px] lg:-mt-[8px] -mb-5 "
              />
              <p className="text-sm leading-6 pt-4 md:max-w-xs text-white">
                Capital Code X uw partner in online success
              </p>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.bedrijf.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm xl-nav-link hover-underline-animation-white leading-6 text-white"
                        >
                          {item.name}
                        </a>
                      </li>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.contact.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm xl-nav-link leading-6 hover-underline-animation-white text-white"
                        >
                          {item.name}
                        </a>
                      </li>
          ...
          <div className="mt-16 border-t border-gray-200/10 pt-8 sm:mt-20 lg:mt-24 flex justify-between">
            <div className="text-xs leading-5 text-white">
              &copy; 2024 Capital Code X, All rights reserved.
            </div>
            <section
              id="newsletter"
            ...
            <div className="text-xs leading-5 flex text-white">
              ...
              <div>
                Site designed by{" "}
                <a
                  href="https://capitalcodex.nl/"
                  className="font-semibold hover:text-black hover:tracking-wider "
                  target="_blank"
