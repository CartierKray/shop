...
export default function Footer() {
  return (
    <>
      <footer
        className="relative bg-gradient-to-b from- to-stone-800 text-black mt-32 lg:mt-20"
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              ...
              />
              <p className="text-sm leading-6 pt-5 md:max-w-xs text-black">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.bedrijf.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm xl-nav-link hover-underline-animation-white leading-6 text-black"
                        >
                          {item.name}
                        </a>
                      </li>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.contact.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm xl-nav-link leading-6 hover-underline-animation-white text-black"
                        >
                          {item.name}
                        </a>
                      </li>
