    ...
    <div>
      <LampContainer>
        <motion.h1
          ...
          className="mt-20 bg-gradient-to-br hidden from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
        >
          Need custom components or websites? <br /> We&apos;ve got you covered
        </motion.h1>
      </LampContainer>
    </div>
  );
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex -mt-10 min-h-[650px] flex-col items-center justify-center overflow-hidden bg-transparent w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-transparent via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-transparent text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[20rem] -translate-y-[7rem] bg-neutral-400 "
        ></motion.div>
